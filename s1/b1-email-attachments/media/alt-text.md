...
|---|---|---|
| 微课 1 · 微课 2（已上线 live） | 写邮件界面示意（内联 SVG） | 写邮件界面示意图：从上到下是收件人、抄送、主题三个框，中间是正文区，正文区下方出现附件的文件名和大小，左下角是发送按钮，旁边是回形针附件按钮。 A sketch of an email compose window: To, Cc and Subject fields top to bottom, the body area in the middle, the attached file's name and size under the body, the Send button bottom left with the paperclip beside it. |
