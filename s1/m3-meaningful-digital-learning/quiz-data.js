/* M3 self-quiz · ungraded · 6 items (W11 uses 0–2, W12 uses 3–5). Each text is [zh, en]; quiz.js shows the active language. */
window.DL_QUIZ=[
 {
  "q": ["小雨的目标是：“这学期我要学好《如何学习》这门课。”按微课 2，它最先缺的是什么？", "Xiao Yu's goal: “This semester I'll do well in Learning How to Learn.” By micro-lesson 2, what is the first thing it lacks?"],
  "options": [["一个能数的终点和一个日期", "A countable end point and a date"], ["更大的雄心", "More ambition"], ["写成英文", "Being written in English"], ["家长的同意", "A parent's approval"]],
  "a": 0,
  "why": ["“学好”没有可测的终点，“这学期”不是一个日期。改成“寒假前学完模块 1–2 的视频和两次小测”，S、M、T 就都有了。", "“Do well” has no measurable end and “this semester” is not a date. “Finish the module 1–2 videos and both quizzes before the break” supplies S, M and T at once."]
 },
 {
  "q": ["小林把主修课写成“有空就学”。一周过去了，一次也没学。微课 1 说，这是四个原因里的哪一个？", "Xiao Lin wrote “study whenever I'm free”. A week passed with no study at all. Which of micro-lesson 1's four causes is this?"],
  "options": [["目标模糊", "A fuzzy goal"], ["切分不当", "Chunks the wrong size"], ["没有时段", "No slot"], ["不够努力", "Not enough effort"]],
  "a": 2,
 ...
 },
 {
  ...
  "options": [["换时间：挪到一个更清醒的白格子", "Move the slot to a more awake white square"], ["下周更努力", "Try harder next week"], ["放弃这门课", "Drop the course"], ["把目标改得更大", "Make the goal bigger"]],
  "a": 0,
